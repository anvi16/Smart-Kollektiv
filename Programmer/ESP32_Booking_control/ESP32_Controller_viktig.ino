...
const char* WIFI_SSID =  "MagnusNett";   // name of your WiFi network
const char* WIFI_PASSWORD =  "Arrkom2021"; // password of the WiFi network
//const char *ssid = "Get-2G-D64371";
//const char *password = "XYU3YXFXTQ";

//
// MQTT: ID, server IP, port, topics
const char* MQTT_CLIENT_ID = "speleman";
...
//IPAddress broker(192,168,0,174);
